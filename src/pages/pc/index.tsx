  ...
  return (
    <Layout title='Inicio'>
      <div>
        ...
        <h2>COMPUTADORAS</h2>
        <p>Ya sea que busques una PC Gamer para jugar o para hacer streaming, una Workstation para tu empresa o profesión, o alguna Computadora armada para realizar proyectos o tareas específicas, podemos hacerla. <strong>El desempeño será evidente.</strong></p>
        </div>
