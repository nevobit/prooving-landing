    ...
    <Layout title="Placeholder">
      <div className="placeholder-content">
        ...
        <div className="placeholder-card">
          ...
          <p className="top">
            <span>Metodo:</span>
            {shippingAddress.paymentMethodHandler}
          </p>
        </div>
        <div className="placeholder-card">
          <h2 className="title">Articulo</h2>
          <p className="top article">
            <Image
        ...
        <div className="placeholder-card">
          ...
          <p className="top">
            <span>Item:</span>
            {DivisaFormater(cartItems[0]?.price)}
          </p>
          <p>
            <span>Tax:</span>
            {DivisaFormater(tax)}
          ...
          <p>
            <span>Envio:</span>
            {DivisaFormater(shipping)}
          </p>
          <p>
            <span>Total:</span>
            {DivisaFormater(totalPrice)}
          </p>
        </div>
        {shippingAddress.paymentMethodHandler == "MercadoPago" ? (
          <form
            action="https://prooving-api-production-ac13.up.railway.app/api/v1/mercadopago"
            method="GET"
          ...
          >
            ...
            <input
              type="hidden"
              name="redirect-url"
              value="https://real-vision-hardware-web.vercel.app"
            />
            <input
              type="hidden"
